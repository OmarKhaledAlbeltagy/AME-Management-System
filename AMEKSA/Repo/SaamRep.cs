...
{
    public class SaamRep : ISaamRep
    {
        private readonly DbContainer db;
        private readonly ITimeRep ti;

        public SaamRep(DbContainer db, ITimeRep ti)
        {
            this.db = db;
            this.ti = ti;
        }
        ...
        {
            Saam saam = db.saam.Where(a=>a.HSAN == s.HSAN).FirstOrDefault();
            ...
            if (saam == null)
            {
                ...
                c.Email = s.Email;
                c.RelationshipNote = "SAAM Registration";
                db.contact.Add(c);
                db.SaveChanges();

                List<Saam> saamlist = db.saam.ToList();
        ...
        public SaamDataModel Start(string gu)
        {
            ...
            Saam s = db.saam.Where(a => a.ContactId == c.Id).FirstOrDefault();
            if (s == null)
            {
                List<Saam> saamlist = db.saam.ToList();
