...
{
    class NumberStringfy
    {
        string NumberAr;
        public NumberStringfy(string Number)
        {
        ...
        private string ConvertNumberToAlpha(string Number)
        {
            if (Number.Contains('.'))
            {
                ...
                else
                {
                    ...
                    {
                        case 1: return convertOneDigits(Number.ToString()) + " ريالاً " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 2: return convertTwoDigits(Number.ToString()) + " ريالاً " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 3: return convertThreeDigits(Number.ToString()) + " ريالاً " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 4: return convertFourDigits(Number.ToString()) + " ريالاً " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 5: return convertFiveDigits(Number.ToString()) + " ريالاً " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        case 6: return convertSixDigits(Number.ToString()) + " ريالاً " + " و " + convertTwoDigits(Number.Split('.')[1]) + " هللة ";
                        default: return "";
                    }
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    {
                        case 1: return convertOneDigits(Number.ToString()) + " ريالاً ";
                        case 2: return convertTwoDigits(Number.ToString()) + " ريالاً ";
                        case 3: return convertThreeDigits(Number.ToString()) + " ريالاً ";
                        case 4: return convertFourDigits(Number.ToString()) + " ريالاً ";
                        case 5: return convertFiveDigits(Number.ToString()) + " ريالاً ";
                        case 6: return convertSixDigits(Number.ToString()) + " ريالاً ";
                        default: return "";
                    }
