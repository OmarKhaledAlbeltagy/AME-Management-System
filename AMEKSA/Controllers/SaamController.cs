...
namespace AMEKSA.Controllers
{
    ...
    [ApiController]
    [AllowAnonymous]
    public class SaamController : ControllerBase
    {
        private readonly ISaamRep rep;
        private readonly ITimeRep ti;

        public SaamController(ISaamRep rep, ITimeRep ti)
        {
            this.rep = rep;
            this.ti = ti;
        }
        ...
        public IActionResult SaamSheet()
        {
            ...
            var worksheet = workbook.Worksheets.Add("SAAM");
            ...
            worksheet.Cell("A1").Value = "Scientific Academy of Aesthetic Medicine";
